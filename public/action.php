...
<table style="width: 100%;">';
    ...
    //splitted inputs for name and surname
    if (!empty($_POST['firstName'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;">First Name:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['firstName'] . '</b></td></tr>';
    }
    if (!empty($_POST['name'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;">Last Name:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['lastName'] . '</b></td></tr>';
    }
    ...
    if (!empty($_POST['message'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;"> Message:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['message'] . '</b></td>';
    }

     $html .= '<tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;">  Time of sending:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $time . '</b></td>
